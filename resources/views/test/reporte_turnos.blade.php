            ...
            <div class="row no-gutters navbarFull" id="NavbarFullsBYB">
                ...
                {{-- <div class="col-10 col-sm-10 col-md-10 col-lg-4 col-xl-3 offset-1 offset-sm-1 offset-md-1 offset-lg-0 offset-xl-0 order-sm-2 order-lg-1 orderBuscaTicket">
                    <form class="d-inline search-form">
                        ...
                        @if ($busqueda != '0') @if ($busqueda == '')
                        <div class="input-group d-flex"><input class="form-control buscaTicketinput" type="text" placeholder="Buscar Opor nombre, apellido o RUT" name="busqueda">
                            <div class="input-group-append"><button class="btn btn-link" type="submit" id="btnBuscaTicket"><i class="fa fa-search"></i></button></div>
                        </div>
                        @else
                        <div class="input-group d-flex"><input class="form-control buscaTicketinput" type="text" value="{{ $busqueda }}" name="busqueda">
                            <div class="input-group-append"><button class="btn btn-link" type="submit" id="btnBuscaTicket"><i class="fa fa-search"></i></button></div>
                        </div>
                        @endif @endif
                ...
                <div class="col-10 col-xl-1 offset-1 offset-xl-1 order-4 LogiHidden">
                    <nav class="navbar navbar-light navbar-expand-md d-inline-block float-right LogoNavbar">
                        <div class="container-fluid">
                            <a class="navbar-brand LogoNavbar" href="#"></a>
                        </div>
                    </nav>
                </div>
            </div>
                    ...
                    <div id="wrapper">
                            ...
                            <div class="row no-gutters align-items-start itemssidebar" style="z-index:1;">
                                <div class="col">
                                    <ol class="sidebar-nav">
                                        ...
                                        <li> <a class="solbtn"
                                                href="{{ route('solicitudesIngresadas') }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 16 16" fill="currentColor"
                        ...
                        <div class="m-4">
                            <ul class="nav nav-tabs" id="myTab">
                                @for ($i = 1; $i <= 6; $i++)
                                    <li class="nav-item">
                                        <a href="#tabMonitor{{ $i }}" class="nav-link active"
                                            data-bs-toggle="tab">Monitor {{ $i }}</a>
                                    </li>
                                @endfor
                            ...
                            <div class="tab-content">
                                @for ($z = 1; $z <= 6; $z++)
                                    <div class="tab-pane fade show active" id="tabMonitor{{ $z }}">
                                        <div id="contenidoRowTByCR">
                                            <div class="col">tabMonitor{{ $z }}</div>
