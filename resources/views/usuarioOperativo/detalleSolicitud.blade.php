                ...
                <div
                    ...
                    <form class="d-inline search-form">
                        <div class="input-group d-flex"><input class="form-control buscaTicketinput" type="text"
                                placeholder="Buscar...">
                            <div class="input-group-append"><a class="btn btn-link" role="button"
                                    id="btnBuscaTicketTO" href="#"><i class="fa fa-search"></i></a></div>
                        </div>
                    </form>
                </div>
                <div
                            ...
                            <div class="row no-gutters align-items-start itemssidebar">
                                <div class="col">
                                    <ol class="sidebar-navTO">
                                        <li> <a class="solbtn"
                                                href="{{ route('solicitudesPendientes') }}"><svg
                                        ...
                                        <li> <a class="solbtn"
                                                href="{{ route('solicitudesFinalizadas') }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 16 16" fill="currentColor"
                        ...
                        <div class="row no-gutters">
                                    ...
                                    <div class="col">
                                        <div class="container containerCard"
                                            ...
                                            <div class="card cardDetallesSeguridadByB">
                                                <div class="card-body">
                                                    <h4 class="card-title" style="color: #46a24a;">Solicitud N°
                                                        {{ $solicitud->id }}</h4>
                                                    <h6 class="text-muted card-subtitle mb-2">Detalles de solicitud</h6>
                                                    <form>
                                                        <div class="form-group"><label>&nbsp;Nombre&nbsp;
                                                                &nbsp;</label><label>{{ $solicitud->nombreCliente }}</label>
                                                        </div>
                                                        <div class="form-group"><label>Apellido&nbsp;
                                                                &nbsp;</label><label>{{ $solicitud->apellidoCliente }}</label>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col">
                                                                <div class="form-group"><label>Rut&nbsp;
                                                        ...
                                                        @if ($solicitud->tipoOrganizacion == 'Empresa')
                                                            <div class="form-row">
                                                                <div class="col">
                                                                    <div class="form-group"><label>Nombre de empresa
                                                                            &nbsp;
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-lg-12 col-xl-10">
                                                                <div class="form-group"><label>Prioridad&nbsp;
                                                                        &nbsp;</label><label>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col text-right"><button class="btn btn-primary"
                                                                id="btnEnviarDetallesTO" type="submit">Agregar</button>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col">
                                ...
                                <form method="POST" action="{{ url('finalizar_solicitud/' . $solicitud->id) }}">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col text-right"><button class="btn btn-primary"
                                                id="btnFinalizarSolicitudTO" type="submit">Finalizar Solicitud</button>
                                        </div>
                                        <input hidden name="id" value="{{ $solicitud->id }}">
                                    </div>
                                </form>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @else
                                                        @foreach ($solicitud->detalles as $detalle)
                                                            <form method="POST"
                                                                action="{{ url('/detalle_solicitud/' . $solicitud->id . '/guardar_detalle/' . $detalle->id) }}">
                                                                @csrf
                                                                {{ method_field('PATCH') }}
                                                                <div class="form-row">
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-xl-12"><label
                                                                                    class="col-form-label">{{ Carbon\Carbon::parse($detalle->fecha)->isoFormat('dddd, D MMMM, YYYY, HH:mm') }}
                                                                                        ...
                                                                                        id="btnGuardarRetroTO"
                                                                                        type="submit">Guardar Cambios</button>

                                                                                    </form>

                                                                                        <form method="POST" action="{{ url('/detalle_solicitud/'.$solicitud->id.'/eliminar_detalle/'.$detalle->id) }}">
                                                                                            @csrf
                                                                                            {{ method_field('DELETE')}}
                                                                                        <button
                                                                                            class="btn btn-primary"
