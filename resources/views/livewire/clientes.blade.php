            ...
            <div class="card-body">
                <div class="row align-middle">
                    ...
                    <div class="col agregarClienteButton">
                        <button class="btn btnSbyb" type="button" data-bs-toggle="modal"
                    ...
                    @if ($sitio != null && $edit == false)
                        <div class="col-auto"><button class="btn btn-primary btnSbyb" type="button"
                    ...
                    <div class="col 12">
                        ...
                        @else
                            <button class="btn btnSbyb"
                                wire:click="guardarCambiosSitio({{ $sitio->id }})">Guardar cambios</button>
                        @endif

                    </div>
                </div>
                <div class="modal-header">
                    <h4 class="modal-title">Modal 1</h4><button class="btn-close" type="button"
