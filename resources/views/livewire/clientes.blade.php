            ...
            <div class="card-body">
                ...
                @if ($edit == false)
                    <div class="row">
                        ...
                        <div class="col d-flex align-items-center"><select class="form-select selectByB shadow-none"
                                wire:model="idSitio">
            ...
            @if ($sitio != null && $edit == false)
                ...
                <div class="row">
                    ...
                    @if ($sitio->alarma == null && $edit == false)
                        <div class="col">
                            <div class="card cardClientes shadow paddingAlarma mb-5 bg-white rounded">
                                <div class="row">
                                    <div class="col ">
                                        @if ($editAlarma == false)
                                        ...
                                        <div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    @if ($editAlarma == false)
                                                        <button class="btn btnSbyb form-control"
                                                            wire:click="agregarAlarma">Añadir Alarma</button>
                                                    @else
                                                        <button class="btn btnSbyb form-control"
                                                            wire:click="guardarCambiosAlarma({{ $sitio->alarma->id }})">Guardar
                                                            Cambios</button>
